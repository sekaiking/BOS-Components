...
pub struct Contract {
    ...
    //keeps track of verified I-AM-HUMAN accounts so that they can only mint one NFT
    pub verified_accounts: UnorderedSet<AccountId>,
...
impl Contract {
    ...
    */
    ...
    pub fn new_default_meta() -> Self {
        ...
        Self::new(
            AccountId::new_unchecked("sking.near".to_string()),
            NFTContractMetadata {
                spec: "nft-1.0.0".to_string(),
                name: "I Am Human NFT Badge".to_string(),
                symbol: "IAHB".to_string(),
                icon: None,
                base_uri: None,
                reference: None,
                reference_hash: None,
